const EducationCard = ({
    ...
    <div className="flex flex-col items-center text-center p-7 rounded-md border border-secondary">
      <h3 className="text-lg md:text-xl font-bold mb-2 text-accent">{title}</h3>
      <p>{percentage}</p>
      <p>{institution}</p>
      <p>{year}</p>
    </div>
...
export default function Education() {
    return (
        <section className="flex items-center justify-center w-full py-10">
            <div className="flex flex-col items-center justify-center p-6 md:p-10 md:w-10/12">
